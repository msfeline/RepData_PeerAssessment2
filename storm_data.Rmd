...
The two sorted lists below by the amount of money cost by damages are for the impact on economy.  
...
## 15              HEAT   401411500
```
the following pair of graphs are for total property damage and total crop damage affected by these severe weather events. 
...
We find that flood and hurricane/typhoon cause most property damage; drought and flood causes most crop damage in the United States from 1995 to 2011.

### Conclusion  
From the various data above, 
(1) excessive heat and tornado are found to be most harmful with respect to population health, while (2) flood, drought, and hurricane/typhoon have the greatest economic consequences.
